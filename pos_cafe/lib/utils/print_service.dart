...
class PrintService {
  ...
  static Future<void> printKitchenTicket(String tableName, List<Map<String, dynamic>> items) async {
    ...
    pdf.addPage(pw.Page(
      ...
      build: (pw.Context context) {
        // Trả về trực tiếp pw.Column, không bọc ConstrainedBox nữa
        return pw.Column(
          mainAxisSize: pw.MainAxisSize.min, // 🔥 ÉP CHIỀU DÀI GỌN NHẤT CÓ THỂ
  ...
  static Future<void> printCustomerReceipt(String tableName, int totalAmount, List<Map<String, dynamic>> items) async {
    ...
    pdf.addPage(pw.Page(
      ...
      theme: pw.ThemeData.withFont(base: fontRegular, bold: fontBold, italic: fontItalic),
      build: (pw.Context context) {
        // Trả về trực tiếp pw.Column, gỡ bỏ ConstrainedBox
        return pw.Column(
          mainAxisSize: pw.MainAxisSize.min, // 🔥 BÍ QUYẾT CẮT GIẤY VỪA KHÍT Ở ĐÂY
  ...
  static Future<void> printShiftReport(int invoiceCount, int totalRevenue, int startingCash, int actualCash, int difference) async {
    ...
    pdf.addPage(pw.Page(
      ...
      build: (pw.Context context) {
        // Trả về trực tiếp pw.Column, gỡ bỏ ConstrainedBox
        return pw.Column(
          mainAxisSize: pw.MainAxisSize.min, // 🔥 BÍ QUYẾT ÉP GIẤY VỪA KHÍT
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          children: [
